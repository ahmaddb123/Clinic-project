...
export const medicalServices: MedicalService[] = [
...

  {
    ...
    description:
      "تقييم حالات الام الصدر لمعرفة الأسباب ومنها ما يصيب الرئة أو القلب أو الجهاز  الهضمي أو الجهاز العصبي أو القفص الصدري أو أسباب أخرى يحددها الطبيب ",
  ...
  {
    title: "تشخيص وعلاج حساسية الصدر ",
    description:
      "نقوم بتقديم خطط علاجية للمرضى الذين يعانون من حساسية الصدر والتي تؤثر على التنفس. تشمل التوعية الصحية بالمرض وذلك للرعاية والوقاية من النوبات الحادة التي تصيب مرضي حساسية الصدر..",
  ...
  {
    title: "جلسات نيبولايزر للحالات الحرجة",
    description:
      "  جلسات أستنشاق رذاذ بأجهزة نيبولايزر لتخفيف حدة الأعراض لنوبات ضيق التنفس حتى تستقر حالة المريض وتحويل الحالات الحرجى إلى المستشفى. ",
    imageUrl: "img-serv-1.jpg",
  },
  {
    title: "تشخيص حالات الإصابة بفيروس كورونا",
    description:
      "تشخيص وعلاج حالات الإصابة بفيروس كورونا المستجد (COVID-19)، ولأسرهم بأتخاذ كافة الأجرائات الصحية لعدم أنتشار المرض مع تقديم الرعاية المناسبة للحالات البسيطة والمتوسطة وتحويل الحالات الخطرة للعلاج والرعاية في المستشفيات المتخصصة, وتقديم النصائح الوقائية للمرضى  .",
    imageUrl: "img-serv-8.jpg",
  },

  {
    title: "علاج الأطفال من صغار السن إلى البالغين",
    description:
      "يقدم الطبيب رعاية طبية متخصصة للأطفال من سن الأشهر حتى البالغين، مع متابعة نموهم وصحتهم العامة، وتقديم العلاجات المناسبة للحالات مثل التهابات الجهاز التنفسي وحساسية الصدر وغيرها من الأمراض الفيروسية التي تصيب الجهاز التنفسي   والجهاز الهضمي.",
    imageUrl: "img-serv-7.jpg",
  },
  {
    title: "متابعة وعلاج أمراض الجهاز التنفسي المزمنة",
    description:
      "نقوم بمتابعة المرضى الذين يعانون من أمراض مزمنة مرتبطة بالجهاز التنفسي والهضمي مثل الربو، والانسداد الرئوي المزمن وأرتجاع المريء، مع تقديم العلاج المناسب للحفاظ على استقرار الحالة.",
    imageUrl: "img-1.jpg",
  },
  {
  ...
  {
    title: "تشخيص وعلاج الأمراض الباطنية مثل مرضى السكر و مرضى إرتفاع ضغط الدم وأمراض القلب",
    description:
      "نختص في تشخيص وعلاج مرض السكر وارتفاع ضغط الدم ومرضى القلب للحالات المستقرة حيث أن هذه الأمراض تنعكس سلبا على الجهاز التنفسي التي قد تسبب العديد من الأعراض التي تصيب الرئة وتحويل الحالات الحرجة إلى المستشفى  .",
    imageUrl: "img-serv-n-10.jpg",
  },
  {
    title: "تشخيص وعلاج الانسداد الشعبي المزمن",
    description:
      "نوفر تقييمًا شاملًا وعلاجًا مخصصًا للانسداد الشعبي المزمن، مع التركيز على تحسين التنفس باستخدام الأدوية الموسعة للشعب الهوائية، والعلاج بالأكسجين، وتقنيات العلاج الطبيعي وتقديم الدعم النفسي والأسري وتحويل الحالات الحرجة منها إلى المستشفى. ",
    imageUrl: "img-serv-n-2.jpg",
  },
  {
    title: "تشخيص وعلاج التهاب الغشاء البللوري",
    description:
      "  نقدم تشخيصًا دقيقًا وعلاج الالتهاب  البللوري، حيث نستخدم الأدوية المضادة للبكتيريا والعلاج الطبيعي لتحسين حالة المرضى إزالة أسباب المرض وذلك بالفحوصات اللازمة لتشخيص الأسباب وعلاجها.",
    imageUrl: "img-serv-n-6.jpg",
  },
  {
    title: "تشخيص وعلاج استرواح الغشاء البللوري",
    description:
      "  نقوم بتقديم الرعاية اللازمة لحالات استرواح الغشاء البللوري،   وتحويل هذه الحالات الحرجة إلى المستشفى.",
  ...
  {
    title: "تشخيص وعلاج النزيف الرئوي ",
    description:
      "نقدم خدمات تشخيص شاملة للنزيف الرئوي، مع إمكانية تقديم العلاجات المناسبة بالأدوية في الحالات البسيطة وتحويل الحالات الحرجة للمستشفى.",
    imageUrl: "img-serv-n-4.jpg",
  },

  {
    title: "تشخيص وعلاج ارتجاع المريء",
    description:
  ...
  {
    title: "تشخيص أورام الرئة",
    description:
      "تشخيص أورام الرئة وتحويل الحالات لتلقي الرعاية والعلاج في المستشفيات المتخصصة",
...
export const doctorExperiences: DoctorExperience[] = [
  {
    ...
    description:
      "الدكتور عبد السلام الشامي هو أستاذ دكتور متخصص في أمراض الصدر والجهاز التنفسي، حاصل على درجة الدكتوراة من جامعة الأزهر، إضافة إلى زمالة مرموقة من كلية أطباء الصدر الأمريكية. يمتلك الدكتور عبد السلام خبرة تمتد لأكثر من 40 عامًا في مجال الطب وإدارة المستشفيات، مما يجعله من أبرز الأطباء في هذا التخصص.",
  },
  {
    id: 2,
    title: "التخصص الدقيق",
    description:
      "طوال مسيرته الطبية، تخصص  الأستاذ الدكتور عبد السلام الشامي في معالجة الأمراض المتعلقة بالجهاز التنفسي، مثل حساسية الصدر والربو. إلى جانب ذلك، يعالج الأمراض الباطنية لدى المرضى، حيث يقدم رعاية طبية شاملة تجمع بين التشخيص الدقيق والعلاج المتقدم.",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description:
      "قام الأستاذ الدكتور عبد السلام الشامي بالتدريس في جامعة الأزهر وفي بعض جامعات الدول العربية لطلاب الطب والصيدلة كما أنه له خبرة كبيرة في أجراء مناظير الجهاز التنفسي وإجراء العمليات الجراحية الخاصة في الرئة كأخذ عينات من الرئة, تصريف الهواء والسوائل من الرئة, فحص وظائف التنفس قبل وبعد العلاج ...",
  },
];
...
export const galleryVideos: { id: number; title: string; videoUrl: string }[] = [
  ...
  },
  {
    id: 7,
    title: "فيديو 6",
    videoUrl: "gallery-ved-7.mp4",
  },
  {
    id: 8,
    title: "فيديو 6",
    videoUrl: "gallery-ved-8.mp4",
  },
  {
    id: 9,
    title: "فيديو 6",
    videoUrl: "gallery-ved-9.jpg.mp4",
  },
];

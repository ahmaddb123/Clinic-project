...
export const doctorExperiences: DoctorExperience[] = [
  ...
  },
  {
    ...
    description:
      "قام الدكتور في التدريس في جامعة الأزهر وفي بعض جامعات الدول العربية لطلاب الطب والصيدلة كما أنه له خبرة كبيرة في أجراء مناظير الجهاز التنفسي وإجراء العمليات الجراحية الخاصة في الرئة كأخذ عينات من الرئة, تصريف الهواء والسوائل من الرئة, فحص وظائف التنفس قبل وبعد العلاج ...",
  },
];

  ...
  return (
    <div className="Gallery">
      ...
      <div className="container mx-auto">
        ...
        <p>
          مرحبًا بكم في معرض الصور والفيديوهات الخاص بنا! هنا يمكنكم مشاهدة مجموعة من الصور
          التي تعكس خدمات العيادة وبيئة العمل لدينا. تجدون أيضًا صور والفيديوهات  
           الخاصة بنا، حيث نشارك لحظات مميزة من أحداثنا ومناسباتنا.
